   ...
   public class AreaFill
   {
      ...
      */
      public static void fill(char[][] g, int r, int c, char ch) {
         if (r < 0 || r >= g.length || c < 0 || c >= g[0].length || g[r][c] != ch || g[r][c] == '*') {
             // Base case: stop recursion if out of bounds, different character, or already visited.
             return;
         }   
         g[r][c] = '*';
         fill(g, r - 1, c, ch);
