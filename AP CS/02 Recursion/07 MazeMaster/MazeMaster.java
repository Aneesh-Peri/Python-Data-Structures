...
public class MazeMaster
{
   public static void main(String[] args)
   {
      ...
      Maze1 m = new Maze1(sc.next()+".txt");  //append the .txt
      m.display();
 ...
 */
   public String findShortestPath(int r, int c)
   {
      ...
      if(maze[r][c]==START||maze[r][c]==DOT)
      {
         ...
         int upPathLen = findShortestLengthPath(r-1, c); // using this function becuase trying to find shortest path in this direction
         ...
         // variables for the next path space. using filler values for now, but will be replaced by the coords for the space with the shortest path
         int nextRowCoord = r;
         int nextColCoord = c;
         ...
         //     "((r, c), pathLength)," + [rest of the path]
