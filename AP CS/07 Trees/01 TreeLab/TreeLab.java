...
// tilt your head towards your left shoulder to see the tree
   ...
   {  
      if(t==null)
         return 0;
      if(t.getLeft() == null && t.getRight() == null) // leafNode
         return 1;
   ...
   */
   ...
   {  
      ...
      if(t.getLeft()!=null)
      {
         LeftCounter = 1+height(t.getLeft());
      }
      if(t.getLeft()!=null)
      {
         RightCounter = 1+height(t.getRight());
      }
   ...
   private static String min(TreeNode t, String min)
   {
      ...
      if(t.getValue().toString().compareTo(min)<0)
      {
       ...
       String min1 = min(t.getLeft(),min);
       String min2 = min(t.getRight(),min);
   ...
   private static String max(TreeNode t, String max)
   {
      ...
      if(t.getValue().toString().compareTo(max)>0)
      {
       ...
       String  max1 = max(t.getLeft(),max);
       String max2 = max(t.getRight(),max);
